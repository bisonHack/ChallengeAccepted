//
//  SoloWorkoutViewController.swift
//  ChallengeAccepted
//
...
class SoloWorkoutViewController: UIViewController, ConfigurationViewControllerDelegate, VideoCaptureDelegate, PoseNetDelegate {
